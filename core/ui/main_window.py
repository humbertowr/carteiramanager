...
class MainWindow:
    ...
    def criar_resumo(self):
        frame = ttk.Frame(self.root, padding=(8, 3), style="Card.TFrame")
        frame.pack(fill="x", padx=8, pady=(4, 3))

        campos = [
            ("Pedidos Abertos", "Abertos"),
            ("Pedidos Bloqueados", "Bloq."),
            ("Clientes Bloq.", "Clientes"),
